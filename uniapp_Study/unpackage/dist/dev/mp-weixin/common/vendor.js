...
var plugin = {
  install(app) {
    ...
    app.mount = function mount2(rootContainer) {
...
function initWorkletMethods(mpMethods, vueMethods) {
  if (vueMethods) {
    Object.keys(vueMethods).forEach((name) => {
      const matches2 = name.match(WORKLET_RE);
      if (matches2) {
        const workletName = matches2[1];
...
function getChild(el, childNum, options) {
  ...
  while (i2 < children.length) {
    if (children[i2].style.display !== "none" && children[i2] !== Sortable.ghost && children[i2] !== Sortable.dragged && closest(children[i2], options.draggable, el, false)) {
  ...
  pluginEvent: function pluginEvent(eventName, sortable, evt) {
    ...
    plugins.forEach(function(plugin2) {
      ...
      if (sortable[plugin2.pluginName][eventNameGlobal]) {
        sortable[plugin2.pluginName][eventNameGlobal](_objectSpread({
          sortable
        }, evt));
      }
      if (sortable.options[plugin2.pluginName] && sortable[plugin2.pluginName][eventName]) {
        sortable[plugin2.pluginName][eventName](_objectSpread({
          sortable
        }, evt));
      }
    });
...
var documentExists = typeof document !== "undefined", PositionGhostAbsolutely = IOS, CSSFloatProperty = Edge || IE11OrLess ? "cssFloat" : "float", supportDraggable = documentExists && !ChromeForAndroid && !IOS && "draggable" in document.createElement("div"), supportCssPointerEvents = function() {
  ...
  sortables.some(function(sortable) {
    if (lastChild(sortable))
      return;
    var rect = getRect(sortable), threshold = sortable[expando].options.emptyInsertThreshold, insideHorizontally = x >= rect.left - threshold && x <= rect.right + threshold, insideVertically = y2 >= rect.top - threshold && y2 <= rect.bottom + threshold;
...
Sortable.mount = function() {
  ...
  plugins2.forEach(function(plugin2) {
    ...
    if (plugin2.utils)
      Sortable.utils = _objectSpread({}, Sortable.utils, plugin2.utils);
    ...
    return (
      ...
      function(modules) {
        ...
        "0390": (
          /***/
          function(module3, exports3, __webpack_require__) {
            var at2 = __webpack_require__("02f4")(true);
            module3.exports = function(S2, index2, unicode) {
              return index2 + (unicode ? at2(S2, index2).length : 1);
            };
          }
        ),
        /***/
        ...
        "1495": (
          ...
          function(module3, exports3, __webpack_require__) {
            ...
            module3.exports = __webpack_require__("9e1e") ? Object.defineProperties : function defineProperties(O2, Properties) {
              anObject(O2);
              ...
              var P2;
              while (length > i2)
                dP.f(O2, P2 = keys[i2++], Properties[P2]);
              return O2;
            };
          }
        ),
        ...
        "230e": (
          ...
          function(module3, exports3, __webpack_require__) {
            ...
            var is3 = isObject2(document2) && isObject2(document2.createElement);
            module3.exports = function(it2) {
              return is3 ? document2.createElement(it2) : {};
            };
          }
        ),
        /***/
        "23c6": (
          ...
          function(module3, exports3, __webpack_require__) {
            ...
            module3.exports = function(it2) {
              var O2, T2, B2;
              return it2 === void 0 ? "Undefined" : it2 === null ? "Null" : typeof (T2 = tryGet(O2 = Object(it2), TAG)) == "string" ? T2 : ARG ? cof(O2) : (B2 = cof(O2)) == "Object" && typeof O2.callee == "function" ? "Arguments" : B2;
            };
          }
        ),
        /***/
        ...
        "2aba": (
          ...
          function(module3, exports3, __webpack_require__) {
            ...
            __webpack_require__("8378").inspectSource = function(it2) {
              return $toString.call(it2);
            };
            (module3.exports = function(O2, key, val, safe) {
              ...
              if (O2[key] === val)
                return;
              if (isFunction2)
                has2(val, SRC) || hide(val, SRC, O2[key] ? "" + O2[key] : TPL.join(String(key)));
              if (O2 === global2) {
                O2[key] = val;
              } else if (!safe) {
                delete O2[key];
          ...
          function(module3, exports3, __webpack_require__) {
            ...
            module3.exports = function(it2, S2) {
              if (!isObject2(it2))
                return it2;
              var fn, val;
              if (S2 && typeof (fn = it2.toString) == "function" && !isObject2(val = fn.call(it2)))
                return val;
          ...
          function(module3, exports3, __webpack_require__) {
            ...
            module3.exports = !$assign || __webpack_require__("79e5")(function() {
              ...
              while (aLen > index2) {
                ...
                var keys = getSymbols ? getKeys(S2).concat(getSymbols(S2)) : getKeys(S2);
                var length = keys.length;
                var j2 = 0;
                var key;
                while (length > j2)
                  if (isEnum.call(S2, key = keys[j2++]))
                    T2[key] = S2[key];
              }
              return T2;
            } : $assign;
        ...
        "7f20": (
          ...
          function(module3, exports3, __webpack_require__) {
            ...
            module3.exports = function(it2, tag, stat) {
              if (it2 && !has2(it2 = stat ? it2 : it2.prototype, TAG))
                def2(it2, TAG, { configurable: true, value: tag });
            };
          }
        ),
        /***/
        ...
        "86cc": (
          ...
          function(module3, exports3, __webpack_require__) {
            ...
            exports3.f = __webpack_require__("9e1e") ? Object.defineProperty : function defineProperty(O2, P2, Attributes) {
              anObject(O2);
            ...
            __webpack_require__("214f")("replace", 2, function(defined, REPLACE, $replace, maybeCallNative) {
              return [
                ...
                function replace(searchValue, replaceValue) {
                  ...
                  return fn !== void 0 ? fn.call(searchValue, O2, replaceValue) : $replace.call(String(O2), searchValue, replaceValue);
                },
        ...
        "aae3": (
          ...
          function(module3, exports3, __webpack_require__) {
            ...
            module3.exports = function(it2) {
              var isRegExp;
              return isObject2(it2) && ((isRegExp = it2[MATCH]) !== void 0 ? !!isRegExp : cof(it2) == "RegExp");
            };
          }
        ),
        /***/
        "ac6a": (
          ...
          function(module3, exports3, __webpack_require__) {
            ...
            for (var collections = getKeys(DOMIterables), i2 = 0; i2 < collections.length; i2++) {
              var NAME = collections[i2];
          ...
          function(module3, __webpack_exports__, __webpack_require__) {
            (function(global2) {
              ...
              var camelize2 = cached(function(str) {
                return str.replace(regex, function(_2, c2) {
        ...
        "cadf": (
          ...
          function(module3, exports3, __webpack_require__) {
            ...
            module3.exports = __webpack_require__("01f9")(Array, "Array", function(iterated, kind) {
              ...
              if (kind == "values")
                return step(0, O2[index2]);
              return step(0, [index2, O2[index2]]);
            }, "values");
          ...
          function(module3, __webpack_exports__, __webpack_require__) {
            ...
            function delegateAndEmit(evtName) {
              ...
              return function(evtData) {
                ...
                emit2.call(_this2, evtName, evtData);
              };
            }
            ...
            var draggableComponent = {
              ...
              mounted: function mounted() {
                ...
                eventsToEmit.forEach(function(elt) {
                  optionsAdded["on" + elt] = emit2.bind(_this3, elt);
                });
...
const pages = [
  {
    path: "pages/listingform/listingform",
    style: {
      navigationBarTitleText: "AI House Video"
    }
  },
  {
...
const tabBar = {
  ...
  list: [
    {
      pagePath: "pages/listingform/listingform",
      text: "",
      iconPath: "static/listform.png",
      selectedIconPath: "static/listform.png"
    },
    {
...
const S = true, b = "mp-weixin", A = I(define_process_env_UNI_SECURE_NETWORK_CONFIG_default), C = b, P = I('{\n    "address": [\n        "127.0.0.1",\n        "192.168.100.198"\n    ],\n    "debugPort": 9000,\n    "initialLaunchType": "local",\n    "servePort": 7000,\n    "skipFiles": [\n        "<node_internals>/**",\n        "C:/Users/Bugco/Desktop/HBuilderX/plugins/unicloud/**/*.js"\n    ]\n}\n'), T = I('[{"provider":"alipay","spaceName":"house-video","spaceId":"env-00jxhffvtcwh","spaceAppId":"2021004187667055","accessKey":"z7HRASPZKzrXNuxa","secretKey":"JTefXbgp3JXb3Gjy"}]') || [];
let O = "";
try {
  O = "__UNI__6B7BDB0";
} catch (e2) {
...
const is2 = "token无效，跳转登录页面", os = "token过期，跳转登录页面", as = { TOKEN_INVALID_TOKEN_EXPIRED: os, TOKEN_INVALID_INVALID_CLIENTID: is2, TOKEN_INVALID: is2, TOKEN_INVALID_WRONG_TOKEN: is2, TOKEN_INVALID_ANONYMOUS_USER: is2 }, cs = { "uni-id-token-expired": os, "uni-id-check-token-failed": is2, "uni-id-token-not-exist": is2, "uni-id-check-device-feature-failed": is2 };
function us(e2, t2) {
  let n2 = "";
